...
namespace QuanLyNhanSu.Persistence.Migrations
{
    ...
    [Migration("20221022161705_AddDepartmentManager")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuanLyNhanSu.Entity.DepartmentManager", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QuanLyNhanSu.Entity.Department", b =>
                {
                    b.HasOne("QuanLyNhanSu.Entity.Location", "Location")
            ...
            modelBuilder.Entity("QuanLyNhanSu.Entity.DepartmentManager", b =>
                {
                    b.HasOne("QuanLyNhanSu.Entity.Department", "Department")
                        .WithOne()
                        .HasForeignKey("QuanLyNhanSu.Entity.DepartmentManager", "DepartmentId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("QuanLyNhanSu.Entity.Employee", "Employee")
                        .WithOne()
                        .HasForeignKey("QuanLyNhanSu.Entity.DepartmentManager", "EmployeeId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
